...
def get_operator_outlier(start_date, end_date, kpi_basename, cord_id, threshold):
    ...
    if not start_date and not end_date:
        ...
        ready_data = {"cord_id": cord_id, "kpi_basename": kpi_basename, "values": [], "outliers": [], "outlier_values": []}
